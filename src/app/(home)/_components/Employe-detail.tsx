...
export default function EmployeDetail() {
  ...
  return (
    <div className="flex flex-col gap-15">
      <section className="w-full md:w-[80vw] px-4 md:px-0">
              ...
              >
                <div className="w-full flex flex-col gap-4 md:gap-7 border border-solid border-gray-300 rounded-lg bg-white p-3 md:p-5">
                  <div className="flex flex-col sm:flex-row gap-3 md:gap-5">
                    <div className="relative w-20 h-20 md:w-30 md:h-28 mx-auto sm:mx-0 border-1 border-gray-500 border-solid rounded-full">
                      <Image
                        src={employee.img}
                        alt="zurag"
                        fill
